...
var _this = this;
var newPostData = { title: "AI with N8N", body: "This is great tool", userId: 1 };
...
function fetchUser() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fetch("https://jsonplaceholder.typicode.com/posts/100")];
                case 1:
                    response = _a.sent();
...
var getMyPost = function () { return __awaiter(_this, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, fetchData({
                    title: 'AI with N8N',
